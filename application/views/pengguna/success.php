		...
		<div class="main-content">
			...
			<div class="container">
				<div class="card">
					...
					<p>Total Harga: Rp.
						<?= isset($total_harga) ? number_format($total_harga, 0, ',', '.') : 'Data tidak tersedia'; ?>
					</p>
					<p>Tanggal Kunjungan: <?= isset($tgl_kunjungan) ? $tgl_kunjungan : 'Data tidak tersedia'; ?></p>
					<a href="<?= site_url('Ctiket/cetakpdf/'.$id_pesanan); ?>" class="btn-print">Cetak Tiket</a>
					<a href="<?= site_url('Cpengguna/index'); ?>" class="btn-back-to-home">Kembali ke Beranda</a>
				</div>
			</div>
		</div>
	</div>
