...
<div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed">
    ...
    <div class="body-wrapper">
        ...
        <div class="container-fluid">
            ...
            <h4 class="mb-4">Daftar Tempat Wisata</h4>
            <div class="card">
                <div class="card-body">
                    <form action="<?= site_url('csponsorship/submit '); ?>" method="post" enctype="multipart/form-data">
                        <div class="mb-3">
                            <label for="namasponsor" class="form-label">Nama Sponsor</label>
                        ...
                        <a href="<?= site_url('cpengelola/submit'); ?>" class="btn btn-secondary">Batal</a>
                    </form>
                </div>
            </div>
        </div>
