    ...
    <aside class="left-sidebar">
    	...
    	<div>
    		<div class="brand-logo d-flex align-items-center justify-content-between">
    			<a href="<?=base_url('Cpengelola/dashboard')?>" class="text-nowrap logo-img">
    				<table>
    					<tbody>
    						<tr>
    		...
    		<nav class="sidebar-nav scroll-sidebar" data-simplebar="">
    			<ul id="sidebarnav">
    				...
    				<li class="sidebar-item">
    					<a class="sidebar-link" href="<?=base_url('Cpengelola/dashboard')?>" aria-expanded="false">
    						<span>
					...
					<li class="sidebar-item">
    					<a class="sidebar-link" href="<?=base_url('csponsorship/index')?>" aria-expanded="false">
    						<span>
